...
if choose == "Observations":
    ...
    "---"
    df_bar_chart = df_2.groupby('location',as_index=False)['total'].sum().sort_values(by='total',ascending=False)
    st.bar_chart(df_bar_chart,x="total", y="location",horizontal=True)
